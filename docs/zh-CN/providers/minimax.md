...
MiniMax is an AI company that builds the **M2/M2.1** model family. 39. 当前以编程为重点的版本是 **MiniMax M2.1**（2025 年 12 月 23 日），专为真实世界的复杂任务打造。
...
- 40. **编程计划路由：** Lightning 后端在 MiniMax 编程计划中不可直接使用。 MiniMax auto-routes most requests to Lightning, but falls back to the
