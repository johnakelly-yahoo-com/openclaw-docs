...
read_when:
  - 41. 你需要在 Moonshot K2（Moonshot 开放平台）与 Kimi Coding 设置之间进行选择
...
43. Moonshot 提供带有 OpenAI 兼容端点的 Kimi API。 Configure the
    provider and set the default model to `moonshot/kimi-k2.5`, or use
    Kimi Coding with `kimi-coding/k2p5`.

Current Kimi K2 model IDs:

44. {/_moonshot-kimi-k2-ids:start_/ && null}
...
```bash
46. openclaw onboard --auth-choice moonshot-api-key
```
