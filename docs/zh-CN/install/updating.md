...
我们**不**推荐将 Bun 用于 Gateway 运行时（存在 WhatsApp/Telegram 的问题）。
...
有关渠道语义和发布说明，请参见 [Development channels](/install/development-channels)。
