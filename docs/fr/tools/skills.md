...
Vous pouvez les filtrer via `metadata.openclaw.requires.config` sur l’entrée de configuration du plugin. Voir [Plugins](/tools/plugin) pour la découverte/la configuration et [Tools](/tools) pour la surface d’outils que ces skills enseignent.
