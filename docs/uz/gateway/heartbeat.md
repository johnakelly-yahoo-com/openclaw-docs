...
- `showAlerts`: model OK bo‘lmagan javob qaytarganda ogohlantirish mazmunini yuboradi.
...
kanallar:
  ...
  slack:
    ...
    accounts:
      ops:
        heartbeat:
          showAlerts: false # faqat ops akkaunti uchun ogohlantirishlarni bostirish
  telegram:
    heartbeat:
      showOk: true
```
...
| Goal                                                        | Config                                                                                   |
| ----------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| Default behavior (silent OKs, alerts on) | _(konfiguratsiya talab qilinmaydi)_                                   |
| Fully silent (no messages, no indicator) | `channels.defaults.heartbeat: { showOk: false, showAlerts: false, useIndicator: false }` |
| Faqat indikator (xabarlar yo‘q)          | `channels.defaults.heartbeat: { showOk: false, showAlerts: false, useIndicator: true }`  |
| OK’lar faqat bitta kanalda                                  | `channels.telegram.heartbeat: { showOk: true }`                                          |
