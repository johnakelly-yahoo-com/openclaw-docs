---
title: "42. Pi integratsiya arxitekturasi"
---

# 43. Pi integratsiya arxitekturasi

44. Ushbu hujjat OpenClaw’ning [pi-coding-agent](https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent) va uning qo‘shni paketlari (`pi-ai`, `pi-agent-core`, `pi-tui`) bilan qanday integratsiyalashishini va AI agent imkoniyatlarini qanday ta’minlashini tavsiflaydi.

## 45. Umumiy ko‘rinish

46. OpenClaw pi SDK’dan foydalanib, AI coding agentini o‘zining xabarlar gateway arxitekturasiga joylashtiradi. 47. Pi’ni subprocess sifatida ishga tushirish yoki RPC rejimidan foydalanish o‘rniga, OpenClaw pi’ning `AgentSession`ini `createAgentSession()` orqali bevosita import qiladi va instansiyalaydi. 48. Ushbu embedded yondashuv quyidagilarni ta’minlaydi:

- 49. Sessiya hayotiy sikli va hodisalarni qayta ishlash ustidan to‘liq nazorat
- 50. Maxsus tool injection (xabarlar, sandbox, kanalga xos amallar)
