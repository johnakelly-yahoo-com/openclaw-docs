...
- 9. **Yetkazib berishni boshqarish**: Ajratilgan vazifalar sukut bo‘yicha `announce` (xulosa) dan foydalanadi; kerak bo‘lsa `none` ni tanlang.
...
| Model   | Main session model              | Main session model                         | 10. Bekor qilinishi mumkin |
...
- 11. Asosiy sessiya kontekstida ko‘rinadigan eslatma/hodisa
